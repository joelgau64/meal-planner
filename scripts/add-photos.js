...
// Usage: node scripts/add-photos.js
...
if (!NOTION_TOKEN) {
  console.error('❌ NOTION_TOKEN manquant. Usage: $env:NOTION_TOKEN="secret_xxx"; node scripts/add-photos.js');
  process.exit(1);
}
...
const TR = {
  ...
  'tatin':'tart tomato','roulés':'fish rolls','vietnamien':'vietnamese food',
  'japonais':'japanese food','italien':'italian food','brocoli':'broccoli',
  'lait de coco':'coconut curry','pommes de terre':'potatoes'
};
