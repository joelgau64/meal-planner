// Script: importe les sauces et marinades dans Notion
// Usage: $env:NOTION_TOKEN="secret_xxx"; node scripts/import-sauces.js
...
const TR = {
  'sauce':'sauce','marinade':'marinade','chermoula':'chermoula moroccan',
  'puttanesca':'puttanesca pasta','amatriciana':'amatriciana pasta',
  'arrabbiata':'arrabbiata pasta','aglio':'aglio olio pasta','genovese':'genovese onion',
  'yassa':'yassa chicken senegal','mafé':'mafe peanut sauce african',
  'suya':'suya spice african','moambe':'moambe palm sauce',
  'tare':'ramen tare japanese','teriyaki':'teriyaki sauce','nuoc cham':'nuoc cham vietnamese',
  'bulgogi':'bulgogi korean','satay':'satay peanut thai','nam jim':'nam jim thai sauce',
  'grecque':'greek marinade','italienne':'italian herb marinade','turque':'turkish yogurt marinade'
};
...
async function main() {
  const recettes = JSON.parse(readFileSync('./scripts/sauces-marinades.json', 'utf8'));
  console.log(`📋 Import de ${recettes.length} recettes...\n`);
